...
export const NAME = "Mattias Uhlegård";
...
export const BLUESKY_IDENTIFIER = "mattiasu.bsky.social";
...
export const SOCIAL_LINKS: {
  ...
  SHOW_RSS: true,
  BLUESKY_URL: "https://bsky.app/profile/mattiasu.bsky.social",
  GITHUB_URL: "https://mattiasu.github.io",
  EMAIL: "mattiasu.dev@uhlegard.se",
};
