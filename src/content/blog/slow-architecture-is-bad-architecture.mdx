---
title: "Architecture that slows down delivery is bad architecture."
...
published: false
tags: ["EA", "collaboration", "Archtiecture"]
---
...
:excalidraw[/src/assets/posts/sme-v-eng.svg]
...
In the next article (this became longer that I thought), I’ll walk through how we’ve started putting this into practice:
...
In the next one, I’ll go deeper into how we’re putting this into practice.

Outcome‑Driven Architecture isn’t a framework. It’s how we make architecture useful again.
